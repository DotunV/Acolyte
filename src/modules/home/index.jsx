  ...
  return (
    <div className="">
      <div className="relative  lg:h-screen h-full">
        ...
        <div className="grid lg:grid-cols-2 grid-cols-1 gap-[40px] h-full pt-[16vh] pb-[4vh] xl:px-[5%] px-[4%] max-w-7xl mx-auto ">
            ...
            <div className="flex justify-start mt-4">
              <div className=" py-6 px-4 rounded-[12px] flex items-center md:gap-4 gap-2 bg-white-200 border border-white-300">
                ...
                <div className="flex justify-between h-full flex-col">
                  ...
                  <button className=" px-4 py-2 bg-white-100 rounded-[8px] thunder_bold text-white text-base flex gap-3 items-center ">
